...
const Skills = () => {
  return <div id="skills" className="container relative z-0 flex flex-col items-center justify-center w-full min-h-screen py-20 group">
    ...
    <div className="relative z-20 grid items-center justify-between h-full grid-cols-2 mt-20 gap-x-1 gap-y-1 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-5">
        <div className="relative z-0 lg:mt-32 flex items-center justify-center transition-all duration-500 ease-in-out bg-blue-600 border border-gray-900  hover:bg-blue-700 hover:bg-opacity-30 min-w-[40vw] md:min-w-[20vw] lg:min-w-[15vw] h-[250px] bg-opacity-5"> 
            <FaReact className="relative z-30 reflection group-hover:fill-red-500" size={100} color="#ffffff"/>
        </div>
        <div className="relative z-0 lg:mt-20 flex items-center justify-center transition-all duration-500 ease-in-out bg-blue-600 border border-gray-900  hover:bg-blue-700 hover:bg-opacity-30 min-w-[40vw] md:min-w-[20vw] lg:min-w-[15vw] h-[250px] bg-opacity-5">
            
            <SiNextdotjs className="relative z-30 reflection group-hover:fill-red-500" size={100} color="#ffffff"/>
        </div>
        <div className="relative z-0 lg:mt-0 flex items-center justify-center transition-all duration-500 ease-in-out bg-blue-600 border border-gray-900  hover:bg-blue-700 hover:bg-opacity-30 min-w-[40vw] md:min-w-[20vw] lg:min-w-[15vw] h-[250px] bg-opacity-5">
