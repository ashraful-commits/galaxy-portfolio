...
const Skills = () => {
  return <div id="skills" className="container relative z-0 flex flex-col items-center justify-center w-full min-h-screen py-20">
    ...
    <div className="relative z-20 grid items-center justify-between h-full grid-cols-2 mt-20 gap-x-1 gap-y-1 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-5">
        <div className="relative z-0 flex items-center justify-center transition-all duration-500 ease-in-out bg-blue-600 border border-gray-900  hover:bg-blue-700 hover:bg-opacity-70 min-w-[40vw] md:min-w-[20vw] lg:min-w-[15vw] min-h-[25vh] bg-opacity-5">
